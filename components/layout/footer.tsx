    ...
    <footer className="bg-gray-900 text-gray-300 py-12 px-4">
      <div className="container mx-auto max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-white text-lg font-medium mb-4">ConcreteMix Pro</h3>
            <p className="text-gray-400 text-sm">
              Professional concrete mix design calculator for engineers, contractors, and construction professionals.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#calculator" className="text-gray-400 hover:text-white text-sm">Calculator</a></li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">© 2025 ConcreteMix Pro. All rights reserved.</p>
